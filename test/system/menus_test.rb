...
class MenusTest < ApplicationSystemTestCase
  ...
  test "should create menu" do
    ...
    fill_in "Menu type", with: @menu.menu_type
    fill_in "Product", with: @menu.product_id
    fill_in "Restautante", with: @menu.restautante_id
    fill_in "Week day", with: @menu.week_day
